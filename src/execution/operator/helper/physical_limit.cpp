...
unique_ptr<PhysicalOperatorState> PhysicalLimit::GetOperatorState(ExecutionContext &execution_context) {
	return make_unique<PhysicalLimitOperatorState>(execution_context, *this, children[0].get(), 0);
}
