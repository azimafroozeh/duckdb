...
public:
	explicit PhysicalChunkScanState(ExecutionContext &execution_context, PhysicalOperator &op) : PhysicalOperatorState(execution_context, op, nullptr), chunk_index(0) {
	}
