...
void SET_ARCH(Plus)::RegisterFunction(BuiltinFunctions &set) {
	...
	functions.AddFunction(
	    ScalarFunction({LogicalType::TINYINT, LogicalType::TINYINT}, LogicalType::TINYINT, plus_default));
    functions.AddFunction(
        ScalarFunction({LogicalType::SMALLINT, LogicalType::SMALLINT}, LogicalType::SMALLINT, plus_default));
    functions.AddFunction(
        ScalarFunction({LogicalType::INTEGER, LogicalType::INTEGER}, LogicalType::INTEGER, plus_default));
    functions.AddFunction(
        ScalarFunction({LogicalType::BIGINT, LogicalType::BIGINT}, LogicalType::BIGINT, plus_default));
